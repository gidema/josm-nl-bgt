...
public class TaskStatus {
    public final static TaskStatus ok = new TaskStatus();
    ...
    public static TaskStatus error(String error) {
        return new TaskStatus(null, error, null);
    }
    
    public static TaskStatus exception(Throwable exception) {
        return new TaskStatus(null, null, exception);
    }
